...
import two from "../assets/20211014_120327_IMG_0059.png";
import three from "../assets/20240202_125744_FullSizeRender.png";
import four from "../assets/20240510_144515_IMG_1645.png";
// #endregion
...
export const projects = [
  ...
  },
  {
    ...
    tags: [{ name: "Typescript" }, { name: "Preact" }, { name: "TypewindCSS" }],
    image: quiz,
...
export const extras = [
  {
    image: two,
    text: "My dog NuoMi :) His name means sticky rice in English",
  }, 
  {
    image: three,
    text: "My International Business Conference. We got the country Bolivia and presented the opportunity for Canadian lithium companies looking to expand",
  },
  {
    image: four,
    text: "The F1 exhibition in Toronto. I don't actually watch F1 but this car looks cool.",
  },
];

export const currently = [
  "Finishing my last term of university", "Looking for full-time positions", "Missing my dog T-T (he's not with me when I'm in Waterloo"
];